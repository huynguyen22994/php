...
class CI_Cart {
	...
	var $product_name_rules	= '\.\:\-_ a-z0-9áàảãạăắằẳẵặâấầẩẫậé� �ẻẽẹêếềểễệóòỏõọơớờở ỡợôốồổỗộúùủũụưứừửữ� ��íìỉĩịýỳỷỹỵđÁÀẢÃẠĂẮẰ ẲẴẶÂẤẦẨẪẬÉÈẺẼẸÊẾỀỂ ỄỆÓÒỎÕỌƠỚỜỞỠỢÔỐỒỔỖ� ��ÚÙỦŨỤƯỨỪỬỮỰÍÌỈĨỊÝỲ�� �ỸỴĐ'; // ho tro font unicode
